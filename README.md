...
````
<dependency>
    <groupId>org.xmmaomao</groupId>
    <artifactId>better-jfinal</artifactId>
    ...
    <configuration>
        ...
        <programs>
            <program>
                ...
                <!-- 启动类 -->
                <mainClass>org.xmmaomao.better.jfinal.Bootstrap</mainClass>
                <jvmSettings>
                    <extraArguments>
...
jfinal.config.class=org.xmmaomao.better.jfinal.demo.DemoConfig    #JfinalConfig配置类
````
